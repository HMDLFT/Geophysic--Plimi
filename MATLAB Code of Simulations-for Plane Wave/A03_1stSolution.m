...
model.vel = ones(Nz, Nx) * 8000;  % Higher velocity area
...
model.recx  = [550,550,550];
Nreceivers  = numel(model.recx);

model.recz  = [1,150,300];
model.dtrec = 0.004;
...
simul.cmap='hsv';   % gray, cool, hot, parula, hsv
