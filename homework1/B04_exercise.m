...
% --------------------------------------------------
% In a homogeneous medium, compute the energy of trace at increasing 
% distance from the source
% Plot the resulting energy vs distance

% ----------------------------------------
% "REALISTIC" MODEL (loaded from a file)
% ----------------------------------------
...
% % % % rows = 251;
% % % % columns = 797;
% % % % model.vel= rand(rows, columns)*1000+200;
